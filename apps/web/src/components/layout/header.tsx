...
// Routes whose breadcrumb label is a fixed string. Anything not in the
// map (e.g. /jobs/{id}) falls through to a runtime-derived label below.
...
export function Header() {
  ...
  const pageTitle =
    pageTitles[pathname] ??
    (pathname.startsWith("/jobs/") ? "Job detail" : "Page");
